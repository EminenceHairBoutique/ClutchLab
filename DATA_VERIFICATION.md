...
| C8 | 4.5 additions (re-verified 2026-07-22): Naruto mode spans Erangel/Livik/Sanhok; Scuderia Ferrari HP collab (July); Fast Swim movement mechanic; Monster Truck handling improved; Metro Royale Ch.33 (Naruto-themed) | [gamespress](https://www.gamespress.com/PUBG-MOBILES-VERSION-45-UPDATE-INTRODUCES-ONE-OF-ITS-BIGGEST-EVER-COLL) (official press release), [themagicrain](https://themagicrain.com/2026/07/pubg-mobile-version-4-5-update-launches-with-naruto-shippuden-collaboration/) (news), [sportsdunia](https://www.sportsdunia.com/gaming/pubg-mobile-4-5-update-to-go-live) (news) | medium-low | Ferrari + map list from the official PR; Fast Swim/Monster Truck/Metro Royale from press. All seeded `unverified`; no numeric magnitudes stored. |
